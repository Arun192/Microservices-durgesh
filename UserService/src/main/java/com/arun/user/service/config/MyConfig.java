package com.arun.user.service.config;

import com.arun.user.service.config.interceptor.RestTemplateInterceptor;
...
public class MyConfig {
    ...
    // Declare the bean of OAuthorizedClientManager
